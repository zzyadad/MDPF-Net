...
def parseXmlFilse(voc_dir, save_dir):
    ...
    with open(save_dir + "/classes.txt", 'w', encoding='utf-8') as classes_file:
    ...
    for xml_file in xml_files:
        ...
        if len(objects) != 0:
            ...
            with open(save_dir + "/" + filename.split(".")[0] + ".txt", 'w', encoding='utf-8') as f:
                for obj in objects:
                    f.write(
...
if __name__ == '__main__':
    ...
    parser.add_argument('--voc-dir', type=str, default=r'datasets/train')
    parser.add_argument('--save-dir', type=str, default=r'datasets/labels/train')
